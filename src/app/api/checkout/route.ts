...
export async function POST() {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            unit_amount: 100,
            product_data: {
              name: "RateDeck Full Card Unlock",
              description:
                "Unlock Markdown download, client email, negotiation scripts, remove watermark, and 1 regenerate.",
            },
          },
        },
      ],
      ...
      metadata: { product: "ratedeck_unlock" },
    });
